...
public class EditPostController {
    ...
    public void editPost() {
        ...
        editPostInputBoundary.editPost(editPostInputData.getID(), editPostInputData.getUsername(), editPostInputData.getPostToEdit(), editPostInputData.getNewContent(), editPostInputData.getDialog());
    }
}
