...
public class EditPostController {
    ...
    public void editPost() {
        ...
        editPostInputBoundary.editPost(editPostInputData.getUsername(),editPostInputData.getPostToEdit(), editPostInputData.getNewContent(), editPostInputData.getDialog());
    }
}
